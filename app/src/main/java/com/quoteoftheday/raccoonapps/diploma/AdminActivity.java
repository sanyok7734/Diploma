...
public class AdminActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, OnMainListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(getResources().getString(R.string.Administrator));
        setSupportActionBar(toolbar);

        navigationView.getMenu().findItem(R.id.people).setChecked(true);
        navigationView.setNavigationItemSelectedListener(this);

        user = (User) getIntent().getParcelableExtra("user");
        Toast.makeText(AdminActivity.this, "" + user.getFirstName() + " - " + user.getLastName(), Toast.LENGTH_SHORT).show();

        openFragment(new ListUserFragment());
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.model:
                ...
                break;
            case R.id.methods:
                openFragment(new ListMethodKEOFragment());
                break;
            case R.id.methods_adapters:
                openFragment(new ListMethodAdapterFragment());
                break;
